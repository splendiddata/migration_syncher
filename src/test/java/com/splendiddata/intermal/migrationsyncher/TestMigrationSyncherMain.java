...
public class TestMigrationSyncherMain extends MigrationSyncherMain {
    ...
    static Stream<Arguments> liveTest() {
        return Stream.of(Arguments.arguments("eb4df46c0d08b04191ffbbd467812648b0231049", false, Collections.emptySet()),
    ...
    public void liveTest(String gitCommitId, boolean expectedToFail, Collection<String> failedFiles)
        ...
        if ("head".equals(gitCommitId)) {
            try {
                MigrationSyncherMain.main(new String[] { TestMigrationSyncherDbInterface.TEST_PROPERTIES_PATH });
        ...
        processPropertiesFile(TestMigrationSyncherDbInterface.TEST_PROPERTIES_PATH);
